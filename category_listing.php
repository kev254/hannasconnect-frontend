...
session_start();
$selection_id = $_GET['cat_id'];

$sql = "SELECT users.*, services.* FROM users INNER JOIN services ON users.id = services.user_id where services.category_id='$selection_id'";
        ...
        <section id="hero" class="d-flex justify-cntent-center align-items-center">
            ...
            <div class="swiper-container swiper hero-swiper">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide"><img src="img/new/slider/img.png" class="carousel-img"
                            alt="Hannasconnect">
                    ...
                    <div class="swiper-slide"><img src="img/new/slider/img-1.png" class="carousel-img"
                            alt="Hannasconnect">
                        <!-- <div class="bg-overlay"></div> -->
                    ...
                    <div class="swiper-slide"><img src="img/new/slider/img-2.png" class="carousel-img"
                            alt="Hannasconnect">
                        <!-- <div class="bg-overlay"></div> -->
                    ...
                    <div class="swiper-slide"><img src="img/new/slider/img-3.png" class="carousel-img"
                            alt="Hannasconnect">
                        <!-- <div class="bg-overlay"></div> -->
            ...
            <div class="container">
                <form class="search-form" action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-3">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <select class="form-control form-control-md mb-3 input-btn" id="constituency"
                                    name="constituency">
                        ...
                        <div class="col-6 col-sm-6"> <!-- Updated col-6 to col-12 col-sm-6 -->
                            <div class="form-group m-0">
                                <div class="input-group">
                                    <input type="text" class="form-control input-btn" placeholder="Looking for"
                                        name="keyword" aria-label="keword">
                                    <div class="input-group-append ms-2">
                                        <button class="brown-btn-filled " type="submit"><i class="mdi mdi-magnify"></i>
                                            Search</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <ul>
                        <li data-aos="fade-up">
                            <i class="fas fa-question-circle icon-help"></i> <a data-bs-toggle="collapse"
                                class="collapse" data-bs-target="#accordion-list-1">
                            ...
                            <div id="accordion-list-1" class="collapse" data-bs-parent=".accordion-list">
                                No, using my Kenyan Guide or perusing, saving contacts and sending to friends and family
                                is
                                absolutely free.
                        ...
                        <li data-aos="fade-up">
                            <i class="fas fa-question-circle icon-help"></i> <a data-bs-toggle="collapse"
                                class="collapse" data-bs-target="#accordion-list-2">
                            ...
                            <div id="accordion-list-2" class="collapse" data-bs-parent=".accordion-list">
                                Yes you can list yourself and your business for absolutely free, however, please note,
                                paying
                        ...
                        <li data-aos="fade-up">
                            <i class="fas fa-question-circle icon-help"></i> <a data-bs-toggle="collapse"
                                class="collapse" data-bs-target="#accordion-list-3">
                            ...
                            <div id="accordion-list-3" class="collapse" data-bs-parent=".accordion-list">
                                The only details we share of you are the details you have shared with us willingly, i.e
                                the details you
                        ...
                        <li data-aos="fade-up">
                            <i class="fas fa-question-circle icon-help"></i> <a data-bs-toggle="collapse"
                                class="collapse" data-bs-target="#accordion-list-4">
                        ...
                        <li data-aos="fade-up">
                            <i class="fas fa-question-circle icon-help"></i> <a data-bs-toggle="collapse"
                                class="collapse" data-bs-target="#accordion-list-5">
                        ...
                        <li data-aos="fade-up">
                            <i class="fas fa-question-circle icon-help"></i> <a data-bs-toggle="collapse"
                                class="collapse" data-bs-target="#accordion-list-6">
                        ...
                        <li data-aos="fade-up">
                            <i class="fas fa-question-circle icon-help"></i> <a data-bs-toggle="collapse"
                                class="collapse" data-bs-target="#accordion-list-7">
