...
$sql = "SELECT users.*, services.* FROM users INNER JOIN services ON users.id = services.user_id WHERE services.id='$service_id'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$fetchedkeyWords = json_decode($row['key_words'], true);
$keys = array();
...
if (isset($_POST['send'])) {
    ...
    if ($category === "1") {
        ...
        $individualUpdateSql = "UPDATE services SET profession = '$profession', name = '$name', slogan = '$slogan', county = '$county', sub_counry = '$sub_county', ward = '$ward', email = '$email', bkf = '$ibfk', physical_address = '$i_physical_address', location_pin = '$i_location_pin', website = '$i_website', working_days = '$i_working_day', open_at = '$i_start_time', clsoing_at = '$i_end_time', social_links = '$i_social_links', price = '$i_price', key_words = '$jsonkeywords', plan = '$plan', price_negotiable = '$i_price_negotiable', category_id = '$category', image_url = '$fileName' WHERE id = $service_id";

    } else if ($category === "2") {
        $individualUpdateSql = "UPDATE services SET name = '$name', user_id = '$lastInsertedUserId', slogan = '$slogan', county = '$county', sub_counry = '$sub_county', ward = '$ward', email = '$email', bkf = '$bbfk', branches = '$b_ranches', location_pin = '$i_location_pin', website = '$b_website', working_days = '$b_working_day', open_at = '$b_start_time', clsoing_at = '$i_end_time', social_links = '$b_social_links', key_words = '$jsonkeywords', plan = '$plan', price_negotiable = '$b_price_negotiable', category_id = '$category', message = '$b_message', image_url = '$fileName' WHERE id = $service_id";
    } else if ($category === "3") {
        $individualUpdateSql = "UPDATE services SET name = '$name', user_id = '$lastInsertedUserId', slogan = '$slogan', county = '$county', sub_counry = '$sub_county', ward = '$ward', email = '$email', plan = '$plan', price = '$e_price', price_negotiable = '$e_price_negotiable', category_id = '$category', service = '$e_service', image_url = '$fileName' WHERE id = $service_id";
    } else if ($category === "4") {
        ...
        $individualUpdateSql = "UPDATE services SET name = '$name', user_id = '$lastInsertedUserId', slogan = '$slogan', county = '$county', sub_counry = '$sub_county', ward = '$ward', email = '$email', plan = '$plan', bkf = '$hbkf', looking_for = '$h_looking_for', profession = '$h_profession', education_level = '$h_facility_level', skill = '$h_skill', salary_expectation = '$h_salary_expectation', image_url = '$fileName', category_id = '$category', cv_url = '$cvfileName' WHERE id = $service_id";

    }
    if ($conn->query($individualUpdateSql) === TRUE) {

        header("Location: index.php");
    } else {
        echo "Error: " . $individualUpdateSql . "<br>" . $conn->error;
    }
                                                ...
                                                <div class="form-group row ">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="slogan" placeholder="Slogan (Profession)" value="<?php echo $row['slogan']; ?>">
                                                    </div>
                                            ...
                                            <div class="form-part-2">
                                                ...
                                                <div class="form-group row" id="individualFields">
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <select class="form-control form-control-user input-btn rounded"
                                                            ...
                                                            <option value="Disk Jockey (Deejay/DJ)">Disk Jockey (Deejay/DJ)</option>
                                                            <option value="Dentist">Dentist</option>
                                                            <option value="Designer">Designer</option>
                                                            <option value="Director">Director</option>
                                                            <option value="Doctor">Doctor</option>
                                                            <option value="Dustman/Refuse collector">Dustman/Refuse collector</option>
                                                            <option value="Electrician">Electrician</option>
                                                            <option value="Engineer">Engineer</option>
                                                            <option value="Event planner">Event planner</option>
                                                            <option value="Fashion Designer">Fashion Designer</option>
                                                            <option value="Fitness trainer">Fitness trainer</option>
                                                            <option value="Fireman/Fire fighter">Fireman/Fire fighter</option>
                                                            <option value="Fisherman">Fisherman</option>
                                                            <option value="Florist">Florist</option>
                                                            <option value="Gardener">Gardener</option>
                                                            <option value="Hairdresser/Hairstylists">Hairdresser/Hairstylists</option>
                                                            <option value="Interior Designer">Interior Designer</option>
                                                            <option value="Journalist">Journalist</option>
                                                            <option value="Lawyer">Lawyer</option>
                                                            <option value="Lecturer">Lecturer</option>
                                                            <option value="Librarian">Librarian</option>
                                                            <option value="Lifeguard/Swimming tutor">Lifeguard/Swimming tutor</option>
                                                            <option value="Make-up-artist">Make-up-artist</option>
                                                            <option value="Marketer">Marketer</option>
                                                            <option value="Marketing analyst">Marketing analyst</option>
                                                            <option value="Mechanic">Mechanic</option>
                                                            <option value="Master of ceremony (M.C)/Hype man">Master of ceremony (M.C)/Hype man</option>
                                                            ...
                                                            <option value="Sales and marketer">Sales and marketer</option>
                                                            <option value="Scientist">Scientist</option>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="best known for" value="<?php echo $row['bkf']; ?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="i_location_pin" placeholder="Location (pin)" value="<?php echo $row['location_pin']; ?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        <label for="best_known_for">Website (optional)</label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="i_website" placeholder="website" value="<?php echo $row['website']; ?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        <label for="social_media">Social media links</label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="i_social_links" placeholder="social" value="<?php echo $row['social_links']; ?>">
                                                    </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="time" class="form-control"
                                                                            id="start_time" name="i_start_time" value="<?php echo $row['open_at']; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="time" class="form-control"
                                                                            id="end_time" name="i_end_time" value="<?php echo $row['clsoing_at']; ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-user input-btn"
                                                            name="i_price" placeholder="Price" value="<?php echo $row['price']; ?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                    ...
                                                    <label for="ward">What id your first keyword term? </label>
                                                        <input type="text"
                                                            ...
                                                            id="key1" placeholder="" value="<?php echo $fetchedkeyWords[0]; ?>">
                                                    </div>
                                                    ...
                                                    <label for="ward">What id your second keyword term?</label>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="" value="<?php echo $fetchedkeyWords[1]; ?>">
                                                    </div>
                                                    <div class="col-sm-3">
                                                    <label for="ward">What id your third keyword term? </label>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="" value="<?php echo $fetchedkeyWords[2]; ?>">
                                                    </div>
                                                    ...
                                                    <label for="ward">What id your fourth keyword term? </label>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="" value="<?php echo $fetchedkeyWords[3]; ?>">
                                                    </div>
                                                    ...
                                                    <label for="ward">What id your fifth keyword term? </label>
                                                        <input type="text"
                                                            ...
                                                            id="key5" placeholder="" value="<?php echo $fetchedkeyWords[4]; ?>">
                                                    </div>
                                                    ...
                                                    <label for="ward">What id your sixth keyword term? </label>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="" value="<?php echo $fetchedkeyWords[5]; ?>">
                                                    </div>
                                                    <div class="col-sm-3">
                                                    <label for="ward">What id your seventh keyword term? </label>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="" value="<?php echo $fetchedkeyWords[6]; ?>">
                                                    </div>
                                                    ...
                                                    <label for="ward">What id your eighth keyword term? </label>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="" value="<?php echo $fetchedkeyWords[7]; ?>">
                                                    </div>
                                                ...
                                                <div class="form-group row" id="businessFields">
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="Optional" value="<?php echo $row['bkf']; ?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        <label for="best_known_for">Location</label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="b_location_pin" placeholder="Location" value="<?php echo $row['location_pin']; ?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        <label for="best_known_for">Website (optional)</label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="b_website" placeholder="website url" value="<?php echo $row['website']; ?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        <label for="social_media">Social media links</label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="b_social_media" placeholder="Optional" value="<?php echo $row['social_links']; ?>">
                                                    </div>
                                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <select class="form-control form-control-user input-btn rounded"
                                                            ...
                                                            <option value="Accommodation and Hospitality">Accommodation and Hospitality</option>
                                                            <option value="Advertising and Marketing Firms">Advertising and Marketing Firms/Agencies
                                                            </option>
                                                            <option value="">Aerospace</option>
                                                            <option value="Agriculture">Agriculture</option>
                                                            <option value="Arts">Arts, Culture, Entertainment and Design</option>
                                                            ...
                                                            <option value="Hairdressing and Beauty Services">Hairdressing and Beauty Services</option>
                                                            ...
                                                            <div class="row mt-3">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="start_time">Start Time</label>
                                                                        <input type="time" class="form-control"
                                                                            id="start_timeb" name="b_start_time" value="<?php echo $row['open_at']; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="end_time">End Time</label>
                                                                        <input type="time" class="form-control"
                                                                            id="end_timeb" name="b_end_time" value="<?php echo $row['clsoing_at']; ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <textarea class="form-control form-control-user input-btn"
                                                        name="b_message" value="<?php echo $row['message']; ?>"></textarea>
                                                    ...
                                                    <textarea class="form-control form-control-user input-btn"
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="bkey1" placeholder="" value="<?php echo $fetchedkeyWords[0]; ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ward">What id your second keyword term? </label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn" name="bkey2"
                                                            id="bkey2" placeholder="" value="<?php echo $fetchedkeyWords[1]; ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ward">What id your third keyword term? </label>
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="bkey3" placeholder="" value="<?php echo $fetchedkeyWords[2]; ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ward">What id your fourth keyword term? </label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn" name="key4"
                                                            id="bkey4" placeholder="" value="<?php echo $fetchedkeyWords[3]; ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ward">What id your fifth keyword term? </label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn" name="bkey5"
                                                            id="bkey5" placeholder="" value="<?php echo $fetchedkeyWords[4]; ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ward">What id your sixth keyword term? </label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn" name="bkey6"
                                                            id="bkey6" placeholder="" value="<?php echo $fetchedkeyWords[5]; ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ward">What id your seventh keyword term? </label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn" name="bkey7"
                                                            id="bkey7" placeholder="" value="<?php echo $fetchedkeyWords[6]; ?>">
                                                    </div>
                                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                                    <label for="ward">What id your eighth keyword term? </label>
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn" name="bkey8"
                                                            id="bkey8" placeholder="" value="<?php echo $fetchedkeyWords[7]; ?>">
                                                    </div>
                                                    <div class="row mt-4 w-100">
                                                        <div class="col-sm-12 d-flex justify-content-end">
                                                            <div class="brown-btn-pill  px-5 waves-effect waves-light me-3"
                                                ...
                                                <div class="form-group row" id="emergencyFields">
                                                    ...
                                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-user input-btn"
                                                            name="e_price" placeholder="Optional" value="<?php echo $row['price']; ?>">
                                                ...
                                                <div class="form-group row" id="hireMeFields">
                                                    ...
                                                    <div class="col-md-6 col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="h_experience" placeholder="Optional" value="<?php echo $row['experience']; ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="h_facility_level" placeholder="Optional" value="<?php echo $row['education_level']; ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <input type="text"
                                                            class="form-control form-control-user input-btn"
                                                            name="h_skill" placeholder="Optional" value="<?php echo $row['skills']; ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-user input-btn"
                                                            name="h_salary_expectation" placeholder="Optional" value="<?php echo $row['salary_expectation']; ?>">
                                                    </div>
