                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <form class="user" method="POST" action="" onsubmit="return onSubmit()">
                                                ...
                                                <input type="text" class="form-control form-control-user input-btn" id="name" placeholder="Name" name="name" required readonly value="<?php echo $_SESSION['user']['name'];?>">
                                                </div>

                                                <div class="form-group">
                                                <label for="">Email</label>    
                                                <input type="email" class="form-control form-control-user input-btn" id="email" placeholder="Email" name="email" required readonly value="<?php echo $_SESSION['user']['email'];?>">
                                                </div>
                                                <div class="form-group">
                                                <label for="">Phone number</label>    
                                                <input type="number" class="form-control form-control-user input-btn" id="phone" placeholder="Phone" name="phone" required readonly value="<?php echo $_SESSION['user']['phone'];?>">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input type="submit" class="brown-btn-filled w-100 waves-effect waves-light" value="Update details" id="signup_btn">
                                                </div>
                                            </form>
                                            <p class="or-divider">
                                         <span class="px-2">   OR</span>
                                          ...
                                          <div class="row mt-4">
                                                <div class="col-12 text-center">
                                                    <button class="btn btn-danger w-100" onclick="performAction(this, ' <?php echo $user_id;?> ', 'delete_account')">Delete my account</button>
                                                </div>
                                            </div>
                                        </div> <!-- end .padding-5 -->
...
<script>
    ...
    if (response.success === true) {
        // Handle success, e.g., update the UI or perform other actions
